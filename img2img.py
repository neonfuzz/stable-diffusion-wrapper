#  Code from:
#  https://colab.research.google.com/github/patil-suraj/Notebooks/blob/master/image_2_image_using_diffusers.ipynb#scrollTo=2YJrHBHlB54B
...
class StableDiffusionImg2ImgPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        if isinstance(prompt, str):
            ...
            raise ValueError(
                "`prompt` has to be of type `str` or `list` "
                f"but is {type(prompt)}"
            )
        ...
        # of equation (2) of the Imagen paper:
        ...
        # have the same signature. eta (η) is only used with the DDIMScheduler,
